...
class WordOfCategory extends Component {
    ...
    render() {
        ...
        const handleAddWord = async () => {
            ...
            if (resultGetExample2 && resultGetExample2.examples.length > 0) {// get min example length
                ...
                //Get example
                let resultGetExample = await getExample(this.props.originalWord);
                console.log(resultGetExample);
                phrase = resultGetExample.example[0];
                console.log("get example 2");
            }
            console.log(phrase);
